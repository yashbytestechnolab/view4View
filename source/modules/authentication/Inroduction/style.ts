...
export const styles = StyleSheet.create({
    ...
    subTitle: {opacity:0.6,textAlign: 'center', marginTop: 16, marginBottom: 35, fontFamily: Fonts?.InterRegular, fontSize: 14, fontWeight: '400', color: Colors?.placeHolderTextBlack },
