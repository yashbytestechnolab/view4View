...
export const styles = StyleSheet.create({
    ...
    skipText: { marginBottom: 30, color: Colors?.black, textAlign: 'right', alignItems: 'center', fontSize: 14, fontFamily: Fonts?.InterRegular, fontWeight: '400' },
    ...
    skipWrapper: {
        position: 'absolute', top: Platform.OS === "ios" ? 70 : 20, right: 18
    },
    pagenationStyle: { position: 'absolute', bottom: Platform.OS === "ios" ? 150 : 180 }
