...
import { colorBackGround, Colors, darkBackGround, F40014, F50012, F60012, F60012SemiBold, F60016, lightBackGround } from '../../../Theme';
          ...
          <>
            {
              item?.isHeaderUi ?
                <View key={item?.name} style={[style.pinkTabWrapper, darkModeTheme && lightBackGround(darkModeTheme)]}>
                  ...
                  <Text key={item?.name} style={[F60012SemiBold.textStyle, style.paddingLeft, colorBackGround(darkModeTheme)]}>
                    {item?.name}
                  </Text>
                </View> :
                <>
